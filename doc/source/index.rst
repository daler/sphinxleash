...
And another function to create a reST-formatted table of the data.  It uses the
:func:`sphinxleash.helpers.rest_table` function, which takes a list of rows and
returns a string containing a reST-formatted table with header:
...
Then we'll create a loop, calling those functions as needed:
